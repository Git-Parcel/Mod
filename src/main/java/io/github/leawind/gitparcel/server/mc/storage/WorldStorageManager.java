package io.github.leawind.gitparcel.server.mc.storage;

import io.github.leawind.gitparcel.core.api.GitParcel;
import io.github.leawind.gitparcel.core.mc.mixin.AccessMinecraftServer;
...
public final class WorldStorageManager {
  ...
  private static final ConcurrentHashMap<Path, WorldStorageManager> CACHE =
