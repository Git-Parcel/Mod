package io.github.leawind.gitparcel.core.mc.commands.arguments;
...
import io.github.leawind.gitparcel.core.api.world.Parcel;
import io.github.leawind.gitparcel.core.mc.commands.arguments.parcelselector.ParcelSelector;
import io.github.leawind.gitparcel.core.mc.commands.arguments.parcelselector.ParcelSelectorParser;
...
public class ParcelArgument implements ArgumentType<ParcelSelector> {
  ...
  public <S> CompletableFuture<Suggestions> listSuggestions(
    ...
    if (context.getSource() instanceof ClientSuggestionProvider provider) {
      names = GitParcel.client().getParcels().values().stream().map(parcel -> parcel.meta().name());
