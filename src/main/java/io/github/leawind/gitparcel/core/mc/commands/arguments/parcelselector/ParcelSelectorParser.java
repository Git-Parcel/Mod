...
public final class ParcelSelectorParser {
  ...
  public static final SimpleCommandExceptionType ERROR_INVALID_NAME_OR_UUID =
      new SimpleCommandExceptionType(Translations.of("argument.gitparcel.parcel.invalid"));
  ...
  public static final DynamicCommandExceptionType ERROR_EXPECTED_OPTION_VALUE =
      new DynamicCommandExceptionType(
          arg -> Translations.esc("argument.gitparcel.parcel.options.valueless", arg));
  ...
  private static void fillSelectorSuggestions(SuggestionsBuilder builder) {
    builder.suggest(
        ...
        Translations.of("argument.gitparcel.parcel.selector.arbitrary"));
    builder.suggest(
        SYNTAX_SELECTOR_START_STRING + SELECTOR_NEAREST,
        Translations.of("argument.gitparcel.parcel.selector.nearest"));
    builder.suggest(
        SYNTAX_SELECTOR_START_STRING + SELECTOR_SIGHTED,
        Translations.of("argument.gitparcel.parcel.selector.sighted"));
  }
