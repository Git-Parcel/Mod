package io.github.leawind.gitparcel.common.minecraft.logic.commands.synchronization;
...
public class FilePathSuggestionProvider<S> implements SuggestionProvider<S> {
  ...
  private static final SimpleCommandExceptionType ERROR_NO_PERMISSION =
      new SimpleCommandExceptionType(Translations.of("argument.gitparcel.filepath.no_permission"));
