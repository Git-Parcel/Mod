...
public class Microparcel extends Parcel {
  int value;
  ...
  public static ArrayList<Microparcel> subdivide(Parcel parcel, Level level, BlockPalette palette) {
    return subdivide(parcel, pos -> palette.collect(level, pos));
  }

  public static ArrayList<Microparcel> subdivide(
      Parcel parcel, Function<BlockPos, Integer> values) {
    ArrayList<Microparcel> microparcels = new ArrayList<>();
